      ...
      <div className="bg-white w-[1000px] h-[85%] overflow-y-scroll h-screen bg-bg rounded-md">
        ...
        <div className="mx-10 my-3 mt-10 font-normal">
          <div>
            ...
            <div className="pt-5">
              <h1 className="text-primary font-medium py-3 mt-5">
                Requirement
              </h1>
          ...
          <h1 className="text-primary font-medium py-3 mt-5 pb-4">
            Requirement Details
          </h1>
          ...
          <div className="mr-14">
            ...
            <div className="pb-1">
              <div>
                ...
                <p>
                  {Query.query_create_time.split("T")[0]}{" "}
                  {Query.query_create_time.split("T")[1].split(".")[0]}
                </p>
              </div>

              <div className="pt-2">
                <h1 className="text-gray-400">Message</h1>
                <p className="text-[14px] text-justify pr-4">
                  {Query.query_message}
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="pt-2">
                ...
                <p className="text-black pr-4">
                  {Client.client_shipping_address}
                </p>
              </div>
          ...
          <div className="grid grid-cols-3">
            {followups.length === 0 ? (
              <div className="flex justify-center items-center text-black h-[100px]">
                No Followups...
              </div>
            ) : (
