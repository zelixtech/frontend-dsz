...
function ClientDetails({ Username, MobileNo, Email, Company, Status }) {
    return (
        <div className='px-4 py-2 mx-4 my-2 flex justify-between items-center bg-white shadow-md  rounded-md'>
            ...
            <div className='flex items-center px-2 w-[15%]'>
                <button className='px-4 py-1 h-8 bg-primary text-base font-[400] text-white rounded-[4px] shadow-sm'> View </button>
            </div>
        </div>
    )
}
